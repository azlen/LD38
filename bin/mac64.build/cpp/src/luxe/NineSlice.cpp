...
HX_STACK_ARG(_options,"_options")
{
	...
	this->top = ((Float)32);
	HX_STACK_LINE(53)
	this->slices = cpp::ArrayBase_obj::__new();
	HX_STACK_LINE(57)
	...
	HX_STACK_LINE(77)
	bool tmp3 = (_options->__Field(HX_HCSTRING("top","\x95","\x66","\x58","\x00"), hx::paccDynamic ) != null());		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(77)
	if ((tmp3)){
		HX_STACK_LINE(77)
	...
	HX_STACK_LINE(78)
	bool tmp4 = (_options->__Field(HX_HCSTRING("left","\x07","\x08","\xb0","\x47"), hx::paccDynamic ) != null());		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(78)
	if ((tmp4)){
		HX_STACK_LINE(78)
	...
	HX_STACK_LINE(79)
	bool tmp5 = (_options->__Field(HX_HCSTRING("right","\xdc","\x0b","\x64","\xe9"), hx::paccDynamic ) != null());		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(79)
	if ((tmp5)){
		HX_STACK_LINE(79)
	...
	HX_STACK_LINE(80)
	bool tmp6 = (_options->__Field(HX_HCSTRING("bottom","\xeb","\xe6","\x78","\x65"), hx::paccDynamic ) != null());		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(80)
	if ((tmp6)){
		HX_STACK_LINE(80)
	...
	HX_STACK_LINE(82)
	bool tmp7 = (_options->__Field(HX_HCSTRING("source_x","\xd4","\x30","\xa4","\x66"), hx::paccDynamic ) != null());		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(82)
	if ((tmp7)){
		HX_STACK_LINE(82)
	...
	HX_STACK_LINE(83)
	bool tmp8 = (_options->__Field(HX_HCSTRING("source_y","\xd5","\x30","\xa4","\x66"), hx::paccDynamic ) != null());		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(83)
	if ((tmp8)){
		HX_STACK_LINE(83)
	...
	HX_STACK_LINE(84)
	bool tmp9 = (_options->__Field(HX_HCSTRING("source_w","\xd3","\x30","\xa4","\x66"), hx::paccDynamic ) != null());		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(84)
	if ((tmp9)){
		HX_STACK_LINE(85)
		...
		HX_STACK_LINE(87)
		this->source_w = tmp10->width;
	}
	HX_STACK_LINE(90)
	bool tmp10 = (_options->__Field(HX_HCSTRING("source_h","\xc4","\x30","\xa4","\x66"), hx::paccDynamic ) != null());		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(90)
	if ((tmp10)){
		HX_STACK_LINE(91)
...
::phoenix::Vector NineSlice_obj::set_size( ::phoenix::Vector _v){
	...
	HX_STACK_ARG(_v,"_v")
	HX_STACK_LINE(330)
	bool tmp = (_v == null());		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(330)
	if ((tmp)){
		HX_STACK_LINE(331)
		::phoenix::Vector tmp1 = _v;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(331)
		::phoenix::Vector tmp2 = this->super::set_size(tmp1);		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(331)
		return tmp2;
	}
	HX_STACK_LINE(334)
	bool tmp1 = this->is_set;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(334)
	bool tmp2 = !(tmp1);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(334)
	if ((tmp2)){
		HX_STACK_LINE(335)
		::phoenix::Vector tmp3 = _v;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(335)
		::phoenix::Vector tmp4 = this->super::set_size(tmp3);		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(335)
		return tmp4;
	}
	HX_STACK_LINE(339)
	Float tmp3 = _v->x;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(339)
	Float tmp4 = _v->y;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(339)
	this->update_size(tmp3,tmp4);
	HX_STACK_LINE(341)
	{
		HX_STACK_LINE(341)
		...
		while((true)){
			...
			HX_STACK_LINE(341)
			Dynamic slice = tmp7;		HX_STACK_VAR(slice,"slice");
			HX_STACK_LINE(341)
			++(_g);
			HX_STACK_LINE(342)
			::phoenix::geometry::QuadPackGeometry tmp8 = this->_geometry;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(342)
			bool tmp9 = (tmp8 != null());		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(342)
			if ((tmp9)){
				HX_STACK_LINE(343)
				::phoenix::geometry::QuadPackGeometry tmp10 = this->_geometry;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(343)
				int tmp11 = slice->__Field(HX_HCSTRING("geometry_id","\x88","\xaa","\x54","\x45"), hx::paccDynamic );		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(343)
				Float tmp12 = slice->__Field(HX_HCSTRING("pos","\x94","\x5d","\x55","\x00"), hx::paccDynamic )->__Field(HX_HCSTRING("x","\x78","\x00","\x00","\x00"), hx::paccDynamic );		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(343)
				Float tmp13 = slice->__Field(HX_HCSTRING("pos","\x94","\x5d","\x55","\x00"), hx::paccDynamic )->__Field(HX_HCSTRING("y","\x79","\x00","\x00","\x00"), hx::paccDynamic );		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(343)
				Float tmp14 = slice->__Field(HX_HCSTRING("width","\x06","\xb6","\x62","\xca"), hx::paccDynamic );		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(343)
				Float tmp15 = slice->__Field(HX_HCSTRING("height","\xe7","\x07","\x4c","\x02"), hx::paccDynamic );		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(343)
				::phoenix::Rectangle tmp16 = ::phoenix::Rectangle_obj::__new(tmp12,tmp13,tmp14,tmp15);		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(343)
				tmp10->quad_resize(tmp11,tmp16);
			}
		}
	}
	HX_STACK_LINE(347)
	::phoenix::Vector tmp5 = _v;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(347)
	::phoenix::Vector tmp6 = this->super::set_size(tmp5);		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(347)
	return tmp6;
}
...
Dynamic _reset = __o__reset.Default(false);
	HX_STACK_FRAME("luxe.NineSlice","_create",0x383a6115,"luxe.NineSlice._create","luxe/NineSlice.hx",351,0xccc9c257)
	HX_STACK_THIS(this)
	...
	HX_STACK_ARG(_reset,"_reset")
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::phoenix::Texture &tmp6,Dynamic &tmp9,Dynamic &tmp11,::phoenix::Color &tmp7,::phoenix::Batcher &tmp12){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",359,0xccc9c257)
				{
					hx::Anon __result = hx::Anon_obj::Create();
			...
			while((true)){
				...
				struct _Function_3_1{
					inline static Dynamic Block( Float &tmp22,Float &tmp20,Float &tmp19,Float &tmp21,::phoenix::Color &tmp24,::phoenix::Rectangle &tmp25){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",369,0xccc9c257)
						{
							hx::Anon __result = hx::Anon_obj::Create();
		...
		HX_STACK_LINE(382)
		::String tmp15 = this->get_name();		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(382)
		::String tmp16 = (tmp15 + HX_HCSTRING(".NineSlice.","\x3c","\x38","\xe9","\xe3"));		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(382)
		::phoenix::geometry::QuadPackGeometry tmp17 = this->_geometry;		HX_STACK_VAR(tmp17,"tmp17");
		HX_STACK_LINE(382)
		::String tmp18 = tmp17->id;		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(382)
		::String tmp19 = (tmp16 + tmp18);		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(382)
		::phoenix::geometry::QuadPackGeometry tmp20 = this->_geometry;		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(382)
		tmp20->id = tmp19;
		HX_STACK_LINE(383)
		::phoenix::geometry::QuadPackGeometry tmp21 = this->_geometry;		HX_STACK_VAR(tmp21,"tmp21");
		HX_STACK_LINE(383)
		this->set_geometry(tmp21);
		HX_STACK_LINE(384)
		::phoenix::Vector tmp22 = _pos;		HX_STACK_VAR(tmp22,"tmp22");
		HX_STACK_LINE(384)
		this->set_pos(tmp22);
		HX_STACK_LINE(386)
		this->added = true;
...
Dynamic _reset = __o__reset.Default(false);
	HX_STACK_FRAME("luxe.NineSlice","create",0x8597abc2,"luxe.NineSlice.create","luxe/NineSlice.hx",391,0xccc9c257)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_pos,"_pos")
	HX_STACK_ARG(_w,"_w")
	HX_STACK_ARG(_h,"_h")
