	...
	HX_STACK_LINE(180)
	{
		...
		HX_STACK_LINE(180)
		{
			...
			if ((tmp3)){
				...
				{
					HX_STACK_LINE(180)
					bool tmp4 = (_this1->pos_changed != null());		HX_STACK_VAR(tmp4,"tmp4");
					HX_STACK_LINE(180)
					...
					if ((tmp5)){
						HX_STACK_LINE(180)
						::phoenix::Vector tmp6 = _this1->pos;		HX_STACK_VAR(tmp6,"tmp6");
						HX_STACK_LINE(180)
						_this1->pos_changed(tmp6);
					}
				}
			}
			HX_STACK_LINE(180)
	...
	HX_STACK_LINE(196)
	{
		...
		HX_STACK_LINE(196)
		{
			...
			if ((tmp3)){
				...
				{
					HX_STACK_LINE(196)
					bool tmp4 = (_this1->scale_changed != null());		HX_STACK_VAR(tmp4,"tmp4");
					HX_STACK_LINE(196)
					bool tmp5;		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(196)
					if ((tmp4)){
					...
					if ((tmp5)){
						HX_STACK_LINE(196)
						::phoenix::Vector tmp6 = _this1->scale;		HX_STACK_VAR(tmp6,"tmp6");
						HX_STACK_LINE(196)
						_this1->scale_changed(tmp6);
					}
				}
			}
			HX_STACK_LINE(196)
