...
{
HX_STACK_FRAME("luxe.ResourceStats","new",0x5187990b,"luxe.ResourceStats.new","luxe/Resources.hx",462,0x2b4e2952)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(473)
	this->unknown = (int)0;
...
::String ResourceStats_obj::toString( ){
	HX_STACK_FRAME("luxe.ResourceStats","toString",0x6d8cbc21,"luxe.ResourceStats.toString","luxe/Resources.hx",479,0x2b4e2952)
	HX_STACK_THIS(this)
	HX_STACK_LINE(482)
	...
	HX_STACK_LINE(485)
	int tmp10 = this->rtt;		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(482)
	...
	HX_STACK_LINE(482)
	::String tmp33 = (tmp32 + HX_HCSTRING("\taudios : ","\xe0","\xd6","\x96","\x43"));		HX_STACK_VAR(tmp33,"tmp33");
	HX_STACK_LINE(491)
	int tmp34 = this->audios;		HX_STACK_VAR(tmp34,"tmp34");
	HX_STACK_LINE(482)
	::String tmp35 = (tmp33 + tmp34);		HX_STACK_VAR(tmp35,"tmp35");
	HX_STACK_LINE(482)
	::String tmp36 = (tmp35 + HX_HCSTRING("\n","\x0a","\x00","\x00","\x00"));		HX_STACK_VAR(tmp36,"tmp36");
	HX_STACK_LINE(482)
	::String tmp37 = (tmp36 + HX_HCSTRING("\tunknown : ","\xc5","\x6e","\xfe","\x02"));		HX_STACK_VAR(tmp37,"tmp37");
	HX_STACK_LINE(492)
	int tmp38 = this->unknown;		HX_STACK_VAR(tmp38,"tmp38");
	HX_STACK_LINE(482)
...
{
		HX_STACK_FRAME("luxe.ResourceStats","reset",0xc2ffd33a,"luxe.ResourceStats.reset","luxe/Resources.hx",496,0x2b4e2952)
		HX_STACK_THIS(this)
		HX_STACK_LINE(498)
		this->total = (int)0;
		HX_STACK_LINE(499)
...
Dynamic ResourceStats_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 3:
		if (HX_FIELD_EQ(inName,"rtt") ) { return rtt; }
		break;
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"audios") ) { return audios; }
		break;
	case 7:
