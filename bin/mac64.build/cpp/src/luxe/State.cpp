...
Void State_obj::onkeyup( ::luxe::KeyEvent event){
{
...
Void State_obj::onkeydown( ::luxe::KeyEvent event){
{
...
Void State_obj::ontextinput( ::luxe::TextEvent event){
{
...
Void State_obj::oninputdown( ::luxe::InputEvent event){
{
...
HX_DEFINE_DYNAMIC_FUNC1(State_obj,oninputdown,(void))

Void State_obj::oninputup( ::luxe::InputEvent event){
{
...
HX_DEFINE_DYNAMIC_FUNC1(State_obj,oninputup,(void))

Void State_obj::onmousedown( ::luxe::MouseEvent event){
{
...
Void State_obj::onmouseup( ::luxe::MouseEvent event){
{
...
Void State_obj::onmousemove( ::luxe::MouseEvent event){
{
...
Void State_obj::onmousewheel( ::luxe::MouseEvent event){
{
...
Void State_obj::ontouchdown( ::luxe::TouchEvent event){
{
...
Void State_obj::ontouchup( ::luxe::TouchEvent event){
{
...
Void State_obj::ontouchmove( ::luxe::TouchEvent event){
{
...
Void State_obj::ongamepadup( ::luxe::GamepadEvent event){
{
...
Void State_obj::ongamepaddown( ::luxe::GamepadEvent event){
{
...
Void State_obj::ongamepadaxis( ::luxe::GamepadEvent event){
{
...
Void State_obj::ongamepaddevice( ::luxe::GamepadEvent event){
{
...
Void State_obj::onwindowmoved( ::snow::types::WindowEvent event){
{
...
Void State_obj::onwindowresized( ::snow::types::WindowEvent event){
{
...
Void State_obj::onwindowsized( ::snow::types::WindowEvent event){
{
...
Void State_obj::onwindowminimized( ::snow::types::WindowEvent event){
{
...
Void State_obj::onwindowrestored( ::snow::types::WindowEvent event){
{
