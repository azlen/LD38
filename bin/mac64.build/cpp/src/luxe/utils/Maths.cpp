...
Float Maths_obj::vec_lengthsq( Float x,Float y){
	HX_STACK_FRAME("luxe.utils.Maths","vec_lengthsq",0xbbbec627,"luxe.utils.Maths.vec_lengthsq","luxe/utils/Maths.hx",130,0x6644526a)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_LINE(131)
	Float tmp = (x * x);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(131)
	Float tmp1 = (y * y);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(131)
...
Float Maths_obj::vec_length( Float x,Float y){
	HX_STACK_FRAME("luxe.utils.Maths","vec_length",0xfaddbd49,"luxe.utils.Maths.vec_length","luxe/utils/Maths.hx",135,0x6644526a)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_LINE(136)
	Float tmp = (x * x);		HX_STACK_VAR(tmp,"tmp");
...
Float Maths_obj::vec_normalize( Float length,Float component){
	HX_STACK_FRAME("luxe.utils.Maths","vec_normalize",0x8b842f0a,"luxe.utils.Maths.vec_normalize","luxe/utils/Maths.hx",140,0x6644526a)
	...
	HX_STACK_LINE(142)
	Float tmp1 = hx::DivEq(component,length);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(142)
	return tmp1;
}
...
Float Maths_obj::vec_dot( Float x,Float y,Float otherx,Float othery){
	HX_STACK_FRAME("luxe.utils.Maths","vec_dot",0xccbc4e46,"luxe.utils.Maths.vec_dot","luxe/utils/Maths.hx",146,0x6644526a)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_ARG(otherx,"otherx")
	HX_STACK_ARG(othery,"othery")
	HX_STACK_LINE(147)
	Float tmp = (x * otherx);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(147)
	Float tmp1 = (y * othery);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(147)
	Float tmp2 = (tmp + tmp1);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(147)
	return tmp2;
