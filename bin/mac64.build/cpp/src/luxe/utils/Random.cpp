...
Float Random_obj::get( ){
	HX_STACK_FRAME("luxe.utils.Random","get",0x0458ffa0,"luxe.utils.Random.get","luxe/utils/Random.hx",33,0x7d2aac44)
	HX_STACK_THIS(this)
	HX_STACK_LINE(34)
...
Float Random_obj::_float( Float min,Dynamic max){
	HX_STACK_FRAME("luxe.utils.Random","float",0xfd869b26,"luxe.utils.Random.float","luxe/utils/Random.hx",39,0x7d2aac44)
	HX_STACK_THIS(this)
...
int Random_obj::_int( Float min,Dynamic max){
	HX_STACK_FRAME("luxe.utils.Random","int",0x045a8bf9,"luxe.utils.Random.int","luxe/utils/Random.hx",46,0x7d2aac44)
	HX_STACK_THIS(this)
	HX_STACK_ARG(min,"min")
	HX_STACK_ARG(max,"max")
	HX_STACK_LINE(47)
...
Float chance = __o_chance.Default(((Float)0.5));
	HX_STACK_FRAME("luxe.utils.Random","bool",0xc6402de0,"luxe.utils.Random.bool","luxe/utils/Random.hx",53,0x7d2aac44)
	HX_STACK_THIS(this)
...
Float chance = __o_chance.Default(((Float)0.5));
	HX_STACK_FRAME("luxe.utils.Random","sign",0xd17839f3,"luxe.utils.Random.sign","luxe/utils/Random.hx",59,0x7d2aac44)
	HX_STACK_THIS(this)
	HX_STACK_ARG(chance,"chance")
{
		HX_STACK_LINE(60)
...
Float chance = __o_chance.Default(((Float)0.5));
	HX_STACK_FRAME("luxe.utils.Random","bit",0x045537d7,"luxe.utils.Random.bit","luxe/utils/Random.hx",65,0x7d2aac44)
	HX_STACK_THIS(this)
	HX_STACK_ARG(chance,"chance")
{
		HX_STACK_LINE(66)
...
{
		HX_STACK_FRAME("luxe.utils.Random","reset",0xe1b81f59,"luxe.utils.Random.reset","luxe/utils/Random.hx",70,0x7d2aac44)
		HX_STACK_THIS(this)
		HX_STACK_LINE(71)
		Float tmp = this->seed;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(71)
...
Float Random_obj::set_initial( Float _initial){
	HX_STACK_FRAME("luxe.utils.Random","set_initial",0x7a9610b1,"luxe.utils.Random.set_initial","luxe/utils/Random.hx",80,0x7d2aac44)
	HX_STACK_THIS(this)
