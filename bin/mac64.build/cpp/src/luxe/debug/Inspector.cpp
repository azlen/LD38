...
Void Inspector_obj::create_window( ){
{
		...
		HX_STACK_LINE(116)
		::luxe::Text tmp18 = ::luxe::Text_obj::__new(tmp17);		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(116)
		this->title = tmp18;
		HX_STACK_LINE(132)
		...
		HX_STACK_LINE(136)
		::phoenix::Color tmp21 = tmp20->rgb((int)5526617);		HX_STACK_VAR(tmp21,"tmp21");
		HX_STACK_LINE(137)
		::phoenix::Vector tmp22 = this->pos;		HX_STACK_VAR(tmp22,"tmp22");
		HX_STACK_LINE(137)
		Float tmp23 = tmp22->x;		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(137)
		::phoenix::Vector tmp24 = this->size;		HX_STACK_VAR(tmp24,"tmp24");
		HX_STACK_LINE(137)
		Float tmp25 = tmp24->x;		HX_STACK_VAR(tmp25,"tmp25");
		HX_STACK_LINE(137)
		Float tmp26 = (tmp25 - (int)14);		HX_STACK_VAR(tmp26,"tmp26");
		HX_STACK_LINE(137)
		...
		HX_STACK_LINE(137)
		Float tmp30 = (tmp29 + (int)6);		HX_STACK_VAR(tmp30,"tmp30");
		HX_STACK_LINE(137)
		::phoenix::Vector tmp31 = ::phoenix::Vector_obj::__new(tmp27,tmp30,null(),null());		HX_STACK_VAR(tmp31,"tmp31");
		HX_STACK_LINE(139)
		::String tmp32;		HX_STACK_VAR(tmp32,"tmp32");
		HX_STACK_LINE(139)
		{
			HX_STACK_LINE(139)
			::luxe::Engine tmp33 = ::Luxe_obj::core;		HX_STACK_VAR(tmp33,"tmp33");
			HX_STACK_LINE(139)
			::luxe::Engine _this = tmp33;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(139)
			::String tmp34 = (HX_HCSTRING("","\x00","\x00","\x00","\x00") + _this->build);		HX_STACK_VAR(tmp34,"tmp34");
			HX_STACK_LINE(139)
			::String tmp35 = (tmp34 + HX_HCSTRING(" / debug:","\x78","\xa2","\x67","\x75"));		HX_STACK_VAR(tmp35,"tmp35");
			HX_STACK_LINE(139)
			bool tmp36 = _this->app->debug;		HX_STACK_VAR(tmp36,"tmp36");
			HX_STACK_LINE(139)
			::String tmp37 = ::Std_obj::string(tmp36);		HX_STACK_VAR(tmp37,"tmp37");
			HX_STACK_LINE(139)
			::String tmp38 = (tmp35 + tmp37);		HX_STACK_VAR(tmp38,"tmp38");
			HX_STACK_LINE(139)
			::String tmp39 = (tmp38 + HX_HCSTRING(" / os:","\x05","\x42","\xbc","\xf0"));		HX_STACK_VAR(tmp39,"tmp39");
			HX_STACK_LINE(139)
			::String tmp40 = _this->app->os;		HX_STACK_VAR(tmp40,"tmp40");
			HX_STACK_LINE(139)
			::String tmp41 = (tmp39 + tmp40);		HX_STACK_VAR(tmp41,"tmp41");
			HX_STACK_LINE(139)
			::String tmp42 = (tmp41 + HX_HCSTRING(" / platform:","\xd6","\x0a","\x95","\x7c"));		HX_STACK_VAR(tmp42,"tmp42");
			HX_STACK_LINE(139)
			::String tmp43 = _this->app->platform;		HX_STACK_VAR(tmp43,"tmp43");
			HX_STACK_LINE(139)
			tmp32 = (tmp42 + tmp43);
		}
		HX_STACK_LINE(139)
		::String tmp33 = (HX_HCSTRING("","\x00","\x00","\x00","\x00") + tmp32);		HX_STACK_VAR(tmp33,"tmp33");
		struct _Function_1_3{
			inline static Dynamic Block( ::String &tmp33,::phoenix::Batcher &tmp19,::phoenix::Color &tmp21,::phoenix::Vector &tmp31){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/debug/Inspector.hx",130,0x41b2cfbc)
				{
					...
					__result->Add(HX_HCSTRING("text","\xad","\xcc","\xf9","\x4c") , tmp33,false);
		...
		HX_STACK_LINE(130)
		Dynamic tmp34 = _Function_1_3::Block(tmp33,tmp19,tmp21,tmp31);		HX_STACK_VAR(tmp34,"tmp34");
		HX_STACK_LINE(130)
		::luxe::Text tmp35 = ::luxe::Text_obj::__new(tmp34);		HX_STACK_VAR(tmp35,"tmp35");
		HX_STACK_LINE(130)
		this->version = tmp35;
		HX_STACK_LINE(144)
		::luxe::Sprite tmp36 = this->window;		HX_STACK_VAR(tmp36,"tmp36");
		HX_STACK_LINE(144)
		tmp36->set_locked(true);
		HX_STACK_LINE(145)
		::luxe::Sprite tmp37 = this->window;		HX_STACK_VAR(tmp37,"tmp37");
		HX_STACK_LINE(145)
		tmp37->geometry->id = HX_HCSTRING("debug.Inspector","\xfc","\xfb","\x99","\xc1");
		HX_STACK_LINE(146)
		::luxe::Text tmp38 = this->title;		HX_STACK_VAR(tmp38,"tmp38");
		HX_STACK_LINE(146)
		tmp38->geometry->id = HX_HCSTRING("debug.title.text","\x7e","\xdd","\x85","\xe1");
		HX_STACK_LINE(147)
		::luxe::Text tmp39 = this->version;		HX_STACK_VAR(tmp39,"tmp39");
		HX_STACK_LINE(147)
		tmp39->geometry->id = HX_HCSTRING("debug.version.text","\xbe","\xe0","\xbf","\xd8");
	}
return null();
}
