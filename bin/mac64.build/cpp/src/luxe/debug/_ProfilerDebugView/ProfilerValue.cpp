...
Void ProfilerValue_obj::set( ){
{
		...
		HX_STACK_LINE(273)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(273)
				::luxe::debug::_ProfilerDebugView::ProfilerValue tmp7 = _g1->__get(_g).StaticCast< ::luxe::debug::_ProfilerDebugView::ProfilerValue >();		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(273)
				::luxe::debug::_ProfilerDebugView::ProfilerValue _offset = tmp7;		HX_STACK_VAR(_offset,"_offset");
				HX_STACK_LINE(273)
				++(_g);
				HX_STACK_LINE(274)
				int tmp8 = _offset->history->length;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(274)
				int tmp9 = (tmp8 - (int)1);		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(274)
				Float tmp10 = _offset->history->__get(tmp9);		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(274)
				hx::SubEq(_t,tmp10);
			}
		}
		HX_STACK_LINE(278)
		Float tmp5 = _t;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(278)
		this->history->push(tmp5);
		HX_STACK_LINE(280)
		int tmp6 = this->history->length;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(280)
		int tmp7 = this->avg;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(280)
		...
		HX_STACK_LINE(286)
		int tmp10 = this->avg;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(286)
		bool tmp11 = (tmp9 == tmp10);		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(286)
		if ((tmp11)){
			HX_STACK_LINE(287)
			Float tmp12 = this->accum;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(287)
			int tmp13 = this->avg;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(287)
			Float tmp14 = (Float(tmp12) / Float(tmp13));		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(287)
			Float __t = tmp14;		HX_STACK_VAR(__t,"__t");
			HX_STACK_LINE(288)
			::luxe::debug::_ProfilerDebugView::ProfilerBar tmp15 = this->bar;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(288)
			Float tmp16 = __t;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(288)
			tmp15->set_value(tmp16);
			HX_STACK_LINE(289)
			this->accum = (int)0;
			HX_STACK_LINE(290)
			this->count = (int)0;
		...
		HX_STACK_LINE(295)
		::luxe::debug::_ProfilerDebugView::ProfilerBar tmp12 = this->bar;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(295)
		...
		if ((tmp13)){
			...
			{
				HX_STACK_LINE(296)
				Float tmp16 = ::Math_obj::pow((int)10,(int)4);		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(296)
				Float n = tmp16;		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(296)
				Float tmp17 = (_t * (int)1000);		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(296)
