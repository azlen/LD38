...
HX_STACK_ARG(_color,"_color")
{
	...
	HX_STACK_LINE(475)
	this->text_item = tmp11;
	HX_STACK_LINE(486)
	::luxe::Draw tmp12 = ::Luxe_obj::draw;		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(487)
	::phoenix::Color tmp13 = ::phoenix::Color_obj::__new(null(),null(),null(),null());		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(487)
	::phoenix::Color tmp14 = tmp13->rgb((int)592137);		HX_STACK_VAR(tmp14,"tmp14");
	HX_STACK_LINE(489)
	::luxe::Debug tmp15 = ::Luxe_obj::debug;		HX_STACK_VAR(tmp15,"tmp15");
	HX_STACK_LINE(489)
	::phoenix::Batcher tmp16 = tmp15->batcher;		HX_STACK_VAR(tmp16,"tmp16");
	HX_STACK_LINE(490)
	::luxe::debug::_ProfilerDebugView::ProfilerGraph tmp17 = this->graph;		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(490)
	Float tmp18 = tmp17->width;		HX_STACK_VAR(tmp18,"tmp18");
	HX_STACK_LINE(490)
	::luxe::debug::_ProfilerDebugView::ProfilerGraph tmp19 = this->graph;		HX_STACK_VAR(tmp19,"tmp19");
	HX_STACK_LINE(490)
	Float tmp20 = tmp19->height;		HX_STACK_VAR(tmp20,"tmp20");
	struct _Function_1_2{
		inline static Dynamic Block( Float &tmp20,::phoenix::Batcher &tmp16,Float &tmp18,::phoenix::Color &tmp14){
	...
	HX_STACK_LINE(486)
	Dynamic tmp21 = _Function_1_2::Block(tmp20,tmp16,tmp18,tmp14);		HX_STACK_VAR(tmp21,"tmp21");
	HX_STACK_LINE(486)
	::phoenix::geometry::QuadGeometry tmp22 = tmp12->box(tmp21);		HX_STACK_VAR(tmp22,"tmp22");
	HX_STACK_LINE(486)
	this->bg_geometry = tmp22;
	HX_STACK_LINE(493)
	::luxe::Draw tmp23 = ::Luxe_obj::draw;		HX_STACK_VAR(tmp23,"tmp23");
	HX_STACK_LINE(494)
	::phoenix::Color tmp24 = _color;		HX_STACK_VAR(tmp24,"tmp24");
	HX_STACK_LINE(496)
	::luxe::Debug tmp25 = ::Luxe_obj::debug;		HX_STACK_VAR(tmp25,"tmp25");
	HX_STACK_LINE(496)
	::phoenix::Batcher tmp26 = tmp25->batcher;		HX_STACK_VAR(tmp26,"tmp26");
	HX_STACK_LINE(497)
	::luxe::debug::_ProfilerDebugView::ProfilerGraph tmp27 = this->graph;		HX_STACK_VAR(tmp27,"tmp27");
	HX_STACK_LINE(497)
	Float tmp28 = tmp27->width;		HX_STACK_VAR(tmp28,"tmp28");
	HX_STACK_LINE(497)
	Float tmp29 = (tmp28 - (int)2);		HX_STACK_VAR(tmp29,"tmp29");
	HX_STACK_LINE(497)
	::luxe::debug::_ProfilerDebugView::ProfilerGraph tmp30 = this->graph;		HX_STACK_VAR(tmp30,"tmp30");
	HX_STACK_LINE(497)
	Float tmp31 = tmp30->height;		HX_STACK_VAR(tmp31,"tmp31");
	HX_STACK_LINE(497)
	Float tmp32 = (tmp31 - (int)2);		HX_STACK_VAR(tmp32,"tmp32");
	struct _Function_1_3{
		inline static Dynamic Block( ::phoenix::Batcher &tmp26,::phoenix::Color &tmp24,Float &tmp29,Float &tmp32){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/debug/ProfilerDebugView.hx",493,0xef83e3c4)
			{
				...
				__result->Add(HX_HCSTRING("w","\x77","\x00","\x00","\x00") , tmp29,false);
	...
	HX_STACK_LINE(493)
	Dynamic tmp33 = _Function_1_3::Block(tmp26,tmp24,tmp29,tmp32);		HX_STACK_VAR(tmp33,"tmp33");
	HX_STACK_LINE(493)
	::phoenix::geometry::QuadGeometry tmp34 = tmp23->box(tmp33);		HX_STACK_VAR(tmp34,"tmp34");
	HX_STACK_LINE(493)
	this->bar_geometry = tmp34;
	HX_STACK_LINE(500)
	this->hide();
}
;
...
::phoenix::Vector ProfilerBar_obj::set_pos( ::phoenix::Vector _p){
	...
	HX_STACK_LINE(547)
	{
		...
		if ((tmp2)){
			...
			{
				HX_STACK_LINE(547)
				bool tmp3 = (_this->pos_changed != null());		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(547)
