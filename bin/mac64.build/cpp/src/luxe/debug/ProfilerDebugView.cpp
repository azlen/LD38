...
HX_STACK_ARG(_debug,"_debug")
{
	...
	HX_STACK_LINE(34)
	::luxe::debug::ProfilerDebugView_obj::lists = tmp1;
}
;
	return null();
}
...
Void ProfilerDebugView_obj::create( ){
{
		...
		HX_STACK_LINE(77)
		::luxe::Text tmp79 = ::luxe::Text_obj::__new(tmp78);		HX_STACK_VAR(tmp79,"tmp79");
		HX_STACK_LINE(77)
		this->memtext = tmp79;
		HX_STACK_LINE(89)
		::luxe::Text tmp80 = this->memtext;		HX_STACK_VAR(tmp80,"tmp80");
		HX_STACK_LINE(89)
		tmp80->color->a = ((Float)0.4);
	}
return null();
}
