					...
					for(::cpp::FastIterator_obj< ::luxe::Entity > *__it = ::cpp::CreateFastIterator< ::luxe::Entity >(tmp18);  __it->hasNext(); ){
						::luxe::Entity _entity = __it->next();
						{
							...
							HX_STACK_LINE(36)
							{
								...
								HX_STACK_LINE(36)
								::luxe::structural::OrderedMap_String_luxe_Component tmp26 = _entity->_components->components;		HX_STACK_VAR(tmp26,"tmp26");
								HX_STACK_LINE(36)
								...
								HX_STACK_LINE(36)
								::luxe::structural::OrderedMap_String_luxe_Component tmp47 = _entity->_components->components;		HX_STACK_VAR(tmp47,"tmp47");
								HX_STACK_LINE(36)
								Dynamic tmp48 = tmp47->_keys->iterator();		HX_STACK_VAR(tmp48,"tmp48");
								HX_STACK_LINE(36)
								for(::cpp::FastIterator_obj< ::String > *__it = ::cpp::CreateFastIterator< ::String >(tmp48);  __it->hasNext(); ){
									::String _name = __it->next();
									{
										HX_STACK_LINE(36)
										::luxe::structural::OrderedMap_String_luxe_Component tmp49 = _entity->_components->components;		HX_STACK_VAR(tmp49,"tmp49");
										HX_STACK_LINE(36)
...
;
		...
		HX_STACK_LINE(29)
		::luxe::Text tmp10 = ::luxe::Text_obj::__new(tmp9);		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(29)
		this->items_list = tmp10;
		HX_STACK_LINE(42)
		::luxe::Text tmp11 = this->items_list;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(42)
		tmp11->geometry->id = HX_HCSTRING("debug.scene.list.geometry","\x85","\x6c","\x5b","\xb1");
		HX_STACK_LINE(44)
		this->resize();
	}
return null();
	...
	HX_STACK_ARG(_depth,"_depth")
{
		...
		HX_STACK_LINE(97)
		::luxe::structural::OrderedMap_String_luxe_Component tmp6 = e->_components->components;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(97)
		...
		HX_STACK_LINE(103)
		::luxe::structural::OrderedMap_String_luxe_Component tmp27 = e->_components->components;		HX_STACK_VAR(tmp27,"tmp27");
		HX_STACK_LINE(103)
		Dynamic tmp28 = tmp27->_keys->iterator();		HX_STACK_VAR(tmp28,"tmp28");
		HX_STACK_LINE(103)
		for(::cpp::FastIterator_obj< ::String > *__it = ::cpp::CreateFastIterator< ::String >(tmp28);  __it->hasNext(); ){
			::String _name = __it->next();
			{
				HX_STACK_LINE(104)
				::luxe::structural::OrderedMap_String_luxe_Component tmp29 = e->_components->components;		HX_STACK_VAR(tmp29,"tmp29");
				HX_STACK_LINE(104)
			...
			for(::cpp::FastIterator_obj< ::luxe::Entity > *__it = ::cpp::CreateFastIterator< ::luxe::Entity >(tmp11);  __it->hasNext(); ){
				::luxe::Entity _entity = __it->next();
				{
					...
					HX_STACK_LINE(127)
					{
						...
						HX_STACK_LINE(127)
						::luxe::structural::OrderedMap_String_luxe_Component tmp19 = _entity->_components->components;		HX_STACK_VAR(tmp19,"tmp19");
						HX_STACK_LINE(127)
						...
						HX_STACK_LINE(127)
						::luxe::structural::OrderedMap_String_luxe_Component tmp40 = _entity->_components->components;		HX_STACK_VAR(tmp40,"tmp40");
						HX_STACK_LINE(127)
						Dynamic tmp41 = tmp40->_keys->iterator();		HX_STACK_VAR(tmp41,"tmp41");
						HX_STACK_LINE(127)
						for(::cpp::FastIterator_obj< ::String > *__it = ::cpp::CreateFastIterator< ::String >(tmp41);  __it->hasNext(); ){
							::String _name = __it->next();
							{
								HX_STACK_LINE(127)
								::luxe::structural::OrderedMap_String_luxe_Component tmp42 = _entity->_components->components;		HX_STACK_VAR(tmp42,"tmp42");
								HX_STACK_LINE(127)
					...
					for(::cpp::FastIterator_obj< ::luxe::Entity > *__it = ::cpp::CreateFastIterator< ::luxe::Entity >(tmp13);  __it->hasNext(); ){
						::luxe::Entity _entity = __it->next();
						{
							...
							HX_STACK_LINE(137)
							{
								...
								HX_STACK_LINE(137)
								::luxe::structural::OrderedMap_String_luxe_Component tmp21 = _entity->_components->components;		HX_STACK_VAR(tmp21,"tmp21");
								HX_STACK_LINE(137)
								...
								::luxe::structural::OrderedMap_String_luxe_Component tmp42 = _entity->_components->components;		HX_STACK_VAR(tmp42,"tmp42");
								HX_STACK_LINE(137)
								Dynamic tmp43 = tmp42->_keys->iterator();		HX_STACK_VAR(tmp43,"tmp43");
								HX_STACK_LINE(137)
								for(::cpp::FastIterator_obj< ::String > *__it = ::cpp::CreateFastIterator< ::String >(tmp43);  __it->hasNext(); ){
									::String _name = __it->next();
									{
										HX_STACK_LINE(137)
										::luxe::structural::OrderedMap_String_luxe_Component tmp44 = _entity->_components->components;		HX_STACK_VAR(tmp44,"tmp44");
										HX_STACK_LINE(137)
...
Void SceneDebugView_obj::onmousewheel( ::luxe::MouseEvent e){
{
		...
		HX_STACK_LINE(177)
		int tmp18 = e->y;		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(177)
