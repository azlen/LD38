...
Void IO_obj::url_open( ::String _url){
{
		...
		HX_STACK_LINE(27)
		::snow::systems::io::IO tmp1 = tmp->app->io;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(27)
		::String tmp2 = _url;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(27)
		tmp1->module->url_open(tmp2);
	}
return null();
}
	...
	HX_STACK_ARG(_slot,"_slot")
{
		...
		HX_STACK_LINE(39)
		bool tmp5 = tmp1->string_save(tmp2,tmp3,tmp4);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(39)
		return tmp5;
	}
}
	...
	HX_STACK_ARG(_slot,"_slot")
{
		...
		HX_STACK_LINE(48)
		::String tmp4 = tmp1->string_load(tmp2,tmp3);		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(48)
		return tmp4;
	}
}
	...
	HX_STACK_ARG(_slot,"_slot")
{
		...
		HX_STACK_LINE(56)
		bool tmp3 = tmp1->string_destroy(tmp2);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(56)
		return tmp3;
	}
}
...
::String IO_obj::get_app_path( ){
	...
	::snow::systems::io::IO tmp1 = tmp->app->io;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(66)
	::String tmp2 = tmp1->module->app_path();		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(66)
	return tmp2;
}
...
::String IO_obj::get_app_path_prefs( ){
	...
	::snow::systems::io::IO tmp1 = tmp->app->io;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(72)
	::String tmp2 = tmp1->module->app_path_prefs();		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(72)
	return tmp2;
}
