...
{
HX_STACK_FRAME("luxe.structural.OrderedMapIterator","new",0x8b5ca708,"luxe.structural.OrderedMapIterator.new","luxe/structural/OrderedMap.hx",17,0x2ffa3116)
HX_STACK_THIS(this)
...
bool OrderedMapIterator_obj::hasNext( ){
	HX_STACK_FRAME("luxe.structural.OrderedMapIterator","hasNext",0x42c3f015,"luxe.structural.OrderedMapIterator.hasNext","luxe/structural/OrderedMap.hx",25,0x2ffa3116)
	HX_STACK_THIS(this)
	HX_STACK_LINE(25)
...
Dynamic OrderedMapIterator_obj::next( ){
	HX_STACK_FRAME("luxe.structural.OrderedMapIterator","next",0x65b5814b,"luxe.structural.OrderedMapIterator.next","luxe/structural/OrderedMap.hx",27,0x2ffa3116)
	HX_STACK_THIS(this)
	HX_STACK_LINE(27)
