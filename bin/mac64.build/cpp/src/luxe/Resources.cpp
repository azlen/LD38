...
Void Resources_obj::untrack( ::luxe::Parcel _cache){
{
		...
		HX_STACK_LINE(53)
		bool _removed = tmp1;		HX_STACK_VAR(_removed,"_removed");
		HX_STACK_LINE(55)
		bool tmp2 = _removed;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(55)
		if ((tmp2)){
			HX_STACK_LINE(56)
	...
	HX_STACK_ARG(_force,"_force")
{
		...
		HX_STACK_LINE(92)
		::luxe::resource::Resource _resource = tmp2;		HX_STACK_VAR(_resource,"_resource");
		HX_STACK_LINE(94)
...
Void Resources_obj::emit( int ev,Dynamic data){
{
		...
		HX_STACK_LINE(132)
		int tmp3 = ev;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(132)
...
::snow::api::Promise Resources_obj::load_audio( ::String _id,Dynamic _options){
	HX_STACK_FRAME("luxe.Resources","load_audio",0xd75bf47e,"luxe.Resources.load_audio","luxe/Resources.hx",322,0x2b4e2952)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_id,"_id")
	HX_STACK_ARG(_options,"_options")
	HX_STACK_LINE(324)
	...
	::luxe::resource::Resource tmp2 = tmp->get(tmp1);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(326)
	::luxe::resource::AudioResource _resource = ((::luxe::resource::AudioResource)(tmp2));		HX_STACK_VAR(_resource,"_resource");
	HX_STACK_LINE(328)
	bool tmp3 = (_resource != null());		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(328)
	if ((tmp3)){
		...
		{
			HX_STACK_LINE(330)
			::luxe::resource::AudioResource _g = _resource;		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(330)
			int _g1 = _g->ref;		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(330)
			int tmp4 = (_g1 + (int)1);		HX_STACK_VAR(tmp4,"tmp4");
		...
		HX_STACK_LINE(331)
		::luxe::resource::AudioResource tmp4 = _resource;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(331)
		::snow::api::Promise tmp5 = ::snow::api::Promise_obj::resolve(tmp4);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(331)
		return tmp5;
	...
	HX_STACK_LINE(336)
	bool _is_stream = false;		HX_STACK_VAR(_is_stream,"_is_stream");
	HX_STACK_LINE(337)
	bool tmp4 = (_options != null());		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(337)
	if ((tmp4)){
		HX_STACK_LINE(338)
		_is_stream = _options->__Field(HX_HCSTRING("is_stream","\x75","\x7b","\x51","\xb6"), hx::paccDynamic );
	}
	struct _Function_1_1{
		inline static Dynamic Block( hx::ObjectPtr< ::luxe::Resources_obj > __this,::String &_id,bool &_is_stream){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/Resources.hx",341,0x2b4e2952)
			{
				hx::Anon __result = hx::Anon_obj::Create();
				__result->Add(HX_HCSTRING("id","\xdb","\x5b","\x00","\x00") , _id,false);
				__result->Add(HX_HCSTRING("system","\xef","\x96","\xe2","\xf2") , __this,false);
	...
	HX_STACK_LINE(341)
	Dynamic tmp5 = _Function_1_1::Block(this,_id,_is_stream);		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(341)
	::luxe::resource::AudioResource tmp6 = ::luxe::resource::AudioResource_obj::__new(tmp5);		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(341)
	_resource = tmp6;
	HX_STACK_LINE(348)
	::luxe::resource::AudioResource tmp7 = _resource;		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(348)
	this->add(tmp7);
	HX_STACK_LINE(350)
	::snow::api::Promise tmp8 = _resource->reload();		HX_STACK_VAR(tmp8,"tmp8");
...
bool Resources_obj::has( ::String _id){
	HX_STACK_FRAME("luxe.Resources","has",0xf6689779,"luxe.Resources.has","luxe/Resources.hx",356,0x2b4e2952)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_id,"_id")
	HX_STACK_LINE(356)
	::haxe::ds::StringMap tmp = this->cache;		HX_STACK_VAR(tmp,"tmp");
...
::luxe::resource::Resource Resources_obj::get( ::String _id){
	HX_STACK_FRAME("luxe.Resources","get",0xf667d8b5,"luxe.Resources.get","luxe/Resources.hx",357,0x2b4e2952)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_id,"_id")
	HX_STACK_LINE(357)
	::haxe::ds::StringMap tmp = this->cache;		HX_STACK_VAR(tmp,"tmp");
...
::luxe::resource::BytesResource Resources_obj::bytes( ::String _id){
	HX_STACK_FRAME("luxe.Resources","bytes",0x6ecee64a,"luxe.Resources.bytes","luxe/Resources.hx",358,0x2b4e2952)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_id,"_id")
	HX_STACK_LINE(358)
	::haxe::ds::StringMap tmp = this->cache;		HX_STACK_VAR(tmp,"tmp");
...
::luxe::resource::TextResource Resources_obj::text( ::String _id){
	HX_STACK_FRAME("luxe.Resources","text",0xad0d8fae,"luxe.Resources.text","luxe/Resources.hx",359,0x2b4e2952)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_id,"_id")
	HX_STACK_LINE(359)
	::haxe::ds::StringMap tmp = this->cache;		HX_STACK_VAR(tmp,"tmp");
...
::luxe::resource::JSONResource Resources_obj::json( ::String _id){
	HX_STACK_FRAME("luxe.Resources","json",0xa67c0529,"luxe.Resources.json","luxe/Resources.hx",360,0x2b4e2952)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_id,"_id")
	HX_STACK_LINE(360)
	::haxe::ds::StringMap tmp = this->cache;		HX_STACK_VAR(tmp,"tmp");
...
::phoenix::Texture Resources_obj::texture( ::String _id){
	HX_STACK_FRAME("luxe.Resources","texture",0x31f21c7a,"luxe.Resources.texture","luxe/Resources.hx",361,0x2b4e2952)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_id,"_id")
	HX_STACK_LINE(361)
	::haxe::ds::StringMap tmp = this->cache;		HX_STACK_VAR(tmp,"tmp");
...
::phoenix::BitmapFont Resources_obj::font( ::String _id){
	HX_STACK_FRAME("luxe.Resources","font",0xa3d420d0,"luxe.Resources.font","luxe/Resources.hx",362,0x2b4e2952)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_id,"_id")
	HX_STACK_LINE(362)
	::haxe::ds::StringMap tmp = this->cache;		HX_STACK_VAR(tmp,"tmp");
...
::phoenix::Shader Resources_obj::shader( ::String _id){
	HX_STACK_FRAME("luxe.Resources","shader",0x7bec0466,"luxe.Resources.shader","luxe/Resources.hx",363,0x2b4e2952)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_id,"_id")
	HX_STACK_LINE(363)
	::haxe::ds::StringMap tmp = this->cache;		HX_STACK_VAR(tmp,"tmp");
...
::luxe::resource::AudioResource Resources_obj::audio( ::String _id){
	HX_STACK_FRAME("luxe.Resources","audio",0xd8b756b5,"luxe.Resources.audio","luxe/Resources.hx",364,0x2b4e2952)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_id,"_id")
	HX_STACK_LINE(364)
	::haxe::ds::StringMap tmp = this->cache;		HX_STACK_VAR(tmp,"tmp");
	...
	::luxe::resource::Resource tmp2 = tmp->get(tmp1);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(364)
	::luxe::resource::AudioResource tmp3 = ((::luxe::resource::AudioResource)(tmp2));		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(364)
	return tmp3;
}
...
Dynamic Resources_obj::fetch( ::String _id){
	HX_STACK_FRAME("luxe.Resources","fetch",0xaf30f219,"luxe.Resources.fetch","luxe/Resources.hx",368,0x2b4e2952)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_id,"_id")
	HX_STACK_LINE(369)
	::haxe::ds::StringMap tmp = this->cache;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("luxe.Resources","update_stats",0x2c221c2a,"luxe.Resources.update_stats","luxe/Resources.hx",372,0x2b4e2952)
		HX_STACK_THIS(this)
...
Dynamic Resources_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"load_audio") ) { return load_audio_dyn(); }
		break;
	case 11:
