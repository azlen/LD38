...
HX_STACK_ARG(properties,"properties")
{
	...
	HX_STACK_LINE(58)
	bool tmp6 = ::luxe::tween::actuators::SimpleActuator_obj::addedEvent;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(58)
	...
	if ((tmp7)){
		...
		HX_STACK_LINE(61)
		Dynamic tmp8 = ::luxe::tween::actuators::SimpleActuator_obj::on_internal_update_dyn();		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(61)
		::Luxe_obj::on((int)4,tmp8);
	}
}
;
	return null();
...
Void SimpleActuator_obj::on_internal_update( Dynamic _){
{
		...
		HX_STACK_LINE(456)
		hx::AddEq(::luxe::tween::actuators::SimpleActuator_obj::update_timer,tmp->frame_delta);
		HX_STACK_LINE(457)
		...
		HX_STACK_LINE(457)
		::luxe::tween::actuators::SimpleActuator_obj::current_time = tmp3;
		HX_STACK_LINE(459)
		Float tmp4 = ::luxe::tween::actuators::SimpleActuator_obj::current_time;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(459)
		Float currentTime = tmp4;		HX_STACK_VAR(currentTime,"currentTime");
		HX_STACK_LINE(461)
		...
		HX_STACK_LINE(466)
		{
			...
			int _g1 = (int)0;		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(466)
			int tmp5 = ::luxe::tween::actuators::SimpleActuator_obj::actuatorsLength;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(466)
			...
			while((true)){
				...
				HX_STACK_LINE(468)
				::luxe::tween::actuators::SimpleActuator tmp9 = ::luxe::tween::actuators::SimpleActuator_obj::actuators->__get(j).StaticCast< ::luxe::tween::actuators::SimpleActuator >();		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(468)
				actuator = tmp9;
				HX_STACK_LINE(470)
				bool tmp10 = (actuator != null());		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(470)
				bool tmp11;		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(470)
				if ((tmp10)){
					HX_STACK_LINE(470)
					tmp11 = actuator->active;
				}
				else{
					HX_STACK_LINE(470)
					tmp11 = false;
				...
				if ((tmp11)){
					HX_STACK_LINE(472)
					bool tmp12 = actuator->timescaled;		HX_STACK_VAR(tmp12,"tmp12");
					HX_STACK_LINE(472)
					Float tmp13;		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(472)
					if ((tmp12)){
						HX_STACK_LINE(472)
						tmp13 = ::luxe::tween::actuators::SimpleActuator_obj::update_timer;
					}
					else{
						HX_STACK_LINE(472)
						tmp13 = ::luxe::tween::actuators::SimpleActuator_obj::current_time;
					}
					HX_STACK_LINE(472)
					currentTime = tmp13;
					HX_STACK_LINE(474)
					bool tmp14 = actuator->timescaled;		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(474)
					bool tmp15;		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(474)
					if ((tmp14)){
						HX_STACK_LINE(474)
						bool tmp16 = actuator->has_timescaled_starttime;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(474)
						bool tmp17 = tmp16;		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(474)
						tmp15 = !(tmp17);
					...
					if ((tmp15)){
						...
						HX_STACK_LINE(476)
						Float tmp16 = ::luxe::tween::actuators::SimpleActuator_obj::update_timer;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(476)
						actuator->startTime = tmp16;
						HX_STACK_LINE(477)
						actuator->timeOffset = actuator->startTime;
					}
					HX_STACK_LINE(480)
					bool tmp16 = (currentTime > actuator->timeOffset);		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(480)
					if ((tmp16)){
						HX_STACK_LINE(481)
						Float tmp17 = currentTime;		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(481)
						actuator->update(tmp17);
					}
					HX_STACK_LINE(484)
					(j)++;
				}
					...
					HX_STACK_LINE(488)
					::luxe::tween::actuators::SimpleActuator_obj::actuators->splice(tmp12,(int)1);
					HX_STACK_LINE(489)
					--(::luxe::tween::actuators::SimpleActuator_obj::actuatorsLength);
				}
			}
