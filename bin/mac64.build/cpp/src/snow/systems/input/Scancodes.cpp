...
::String Scancodes_obj::name( int scancode){
	HX_STACK_FRAME("snow.systems.input.Scancodes","name",0x42119da9,"snow.systems.input.Scancodes.name","snow/systems/input/Keycodes.hx",404,0x173a785b)
	...
	if ((tmp)){
		...
		HX_STACK_LINE(408)
		int tmp3 = ::snow::systems::input::Scancodes_obj::scancode_names->length;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(408)
	...
	if ((tmp1)){
		HX_STACK_LINE(409)
		::String tmp2 = ::snow::systems::input::Scancodes_obj::scancode_names->__get(scancode);		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(409)
		res = tmp2;
	}
	HX_STACK_LINE(412)
