...
{
HX_STACK_FRAME("snow.systems.assets.Asset","new",0x43d2796c,"snow.systems.assets.Asset.new","snow/systems/assets/Asset.hx",12,0x7a5509c3)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("snow.systems.assets.Asset","destroy",0x9fdc4c06,"snow.systems.assets.Asset.destroy","snow/systems/assets/Asset.hx",39,0x7a5509c3)
		HX_STACK_THIS(this)
	}
return null();
}
...
Dynamic Asset_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"system") ) { _system=inValue.Cast< ::snow::systems::assets::Assets >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::snow::systems::assets::Assets*/ ,(int)offsetof(Asset_obj,_system),HX_HCSTRING("system","\xef","\x96","\xe2","\xf2")},
