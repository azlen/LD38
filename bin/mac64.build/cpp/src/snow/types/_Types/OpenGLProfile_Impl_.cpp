...
::String OpenGLProfile_Impl__obj::toString( int this1){
	HX_STACK_FRAME("snow.types._Types.OpenGLProfile_Impl_","toString",0xfae03454,"snow.types._Types.OpenGLProfile_Impl_.toString","snow/types/Types.hx",437,0x72b41ce7)
	...
	switch( (int)(tmp)){
		...
		case (int)2: {
			HX_STACK_LINE(441)
			tmp1 = HX_HCSTRING("gles","\xd3","\x45","\x67","\x44");
		}
		;break;
		default: {
			HX_STACK_LINE(442)
