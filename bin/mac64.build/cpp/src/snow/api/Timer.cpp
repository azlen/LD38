...
HX_STACK_ARG(_time,"_time")
{
	...
	HX_STACK_LINE(19)
	Float tmp3 = this->time;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(19)
...
Dynamic Timer_obj::measure( Dynamic f,Dynamic pos){
	...
	Float tmp2 = (tmp - tmp1);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(25)
	Float t0 = tmp2;		HX_STACK_VAR(t0,"t0");
	HX_STACK_LINE(26)
	Dynamic tmp3 = f();		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(26)
	Dynamic r = tmp3;		HX_STACK_VAR(r,"r");
	HX_STACK_LINE(27)
	Float tmp4 = linc::timestamp::now();		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(27)
	Float tmp5 = ::snow::modules::sdl::Runtime_obj::timestamp_start;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(27)
	Float tmp6 = (tmp4 - tmp5);		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(27)
	Float tmp7 = t0;		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(27)
	Float tmp8 = (tmp6 - tmp7);		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(27)
	::String tmp9 = (tmp8 + HX_HCSTRING("s","\x73","\x00","\x00","\x00"));		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(27)
	Dynamic tmp10 = pos;		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(27)
	::haxe::Log_obj::trace(tmp9,tmp10);
	HX_STACK_LINE(28)
	Dynamic tmp11 = r;		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(28)
	return tmp11;
}
...
Void Timer_obj::update( ){
{
		...
		HX_STACK_LINE(48)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(48)
				::snow::api::Timer tmp5 = _g1->__get(_g).StaticCast< ::snow::api::Timer >();		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(48)
				::snow::api::Timer timer = tmp5;		HX_STACK_VAR(timer,"timer");
				HX_STACK_LINE(48)
				++(_g);
				HX_STACK_LINE(49)
				bool tmp6 = timer->running;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(49)
				if ((tmp6)){
					HX_STACK_LINE(50)
					bool tmp7 = (timer->fire_at < now);		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(50)
					if ((tmp7)){
						HX_STACK_LINE(51)
