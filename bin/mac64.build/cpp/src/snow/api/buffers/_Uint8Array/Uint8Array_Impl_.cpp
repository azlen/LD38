...
::snow::api::buffers::ArrayBufferView Uint8Array_Impl__obj::_new( int _elements){
	HX_STACK_FRAME("snow.api.buffers._Uint8Array.Uint8Array_Impl_","_new",0x9168cbc6,"snow.api.buffers._Uint8Array.Uint8Array_Impl_._new","snow/api/buffers/Uint8Array.hx",63,0xd9e22306)
...
::snow::api::buffers::ArrayBufferView Uint8Array_Impl__obj::fromArray( cpp::ArrayBase _array){
	HX_STACK_FRAME("snow.api.buffers._Uint8Array.Uint8Array_Impl_","fromArray",0xf4e6534a,"snow.api.buffers._Uint8Array.Uint8Array_Impl_.fromArray","snow/api/buffers/Uint8Array.hx",68,0xd9e22306)
	...
	HX_STACK_LINE(69)
	{
		...
		HX_STACK_LINE(69)
		::snow::api::buffers::ArrayBufferView tmp1 = ::snow::api::buffers::ArrayBufferView_obj::__new((int)4);		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(69)
...
::snow::api::buffers::ArrayBufferView Uint8Array_Impl__obj::fromView( ::snow::api::buffers::ArrayBufferView _view){
	HX_STACK_FRAME("snow.api.buffers._Uint8Array.Uint8Array_Impl_","fromView",0x6bf04dd4,"snow.api.buffers._Uint8Array.Uint8Array_Impl_.fromView","snow/api/buffers/Uint8Array.hx",72,0xd9e22306)
	...
	{
		HX_STACK_LINE(73)
		int _type = (int)4;		HX_STACK_VAR(_type,"_type");
		HX_STACK_LINE(73)
...
::snow::api::buffers::ArrayBufferView Uint8Array_Impl__obj::fromBuffer( Array< unsigned char > _buffer,int _byteOffset,int _byteLength){
	HX_STACK_FRAME("snow.api.buffers._Uint8Array.Uint8Array_Impl_","fromBuffer",0x6d46d22f,"snow.api.buffers._Uint8Array.Uint8Array_Impl_.fromBuffer","snow/api/buffers/Uint8Array.hx",76,0xd9e22306)
...
::snow::api::buffers::ArrayBufferView Uint8Array_Impl__obj::subarray( ::snow::api::buffers::ArrayBufferView this1,int begin,Dynamic end){
	HX_STACK_FRAME("snow.api.buffers._Uint8Array.Uint8Array_Impl_","subarray",0xc756a0fe,"snow.api.buffers._Uint8Array.Uint8Array_Impl_.subarray","snow/api/buffers/Uint8Array.hx",82,0xd9e22306)
...
Dynamic _byteOffset = __o__byteOffset.Default(0);
	HX_STACK_FRAME("snow.api.buffers._Uint8Array.Uint8Array_Impl_","fromBytes",0x8ceeee1c,"snow.api.buffers._Uint8Array.Uint8Array_Impl_.fromBytes","snow/api/buffers/Uint8Array.hx",85,0xd9e22306)
...
::haxe::io::Bytes Uint8Array_Impl__obj::toBytes( ::snow::api::buffers::ArrayBufferView this1){
	HX_STACK_FRAME("snow.api.buffers._Uint8Array.Uint8Array_Impl_","toBytes",0x9b0aebab,"snow.api.buffers._Uint8Array.Uint8Array_Impl_.toBytes","snow/api/buffers/Uint8Array.hx",90,0xd9e22306)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(91)
...
::String Uint8Array_Impl__obj::toString( ::snow::api::buffers::ArrayBufferView this1){
	HX_STACK_FRAME("snow.api.buffers._Uint8Array.Uint8Array_Impl_","toString",0xf8441d91,"snow.api.buffers._Uint8Array.Uint8Array_Impl_.toString","snow/api/buffers/Uint8Array.hx",96,0xd9e22306)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(96)
	...
	if ((tmp)){
		...
		HX_STACK_LINE(96)
		::String tmp2 = (HX_HCSTRING("Uint8Array [byteLength:","\xb6","\x7b","\x69","\x5e") + this1->byteLength);		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(96)
...
int Uint8Array_Impl__obj::get_length( ::snow::api::buffers::ArrayBufferView this1){
	HX_STACK_FRAME("snow.api.buffers._Uint8Array.Uint8Array_Impl_","get_length",0xe8fd14d4,"snow.api.buffers._Uint8Array.Uint8Array_Impl_.get_length","snow/api/buffers/Uint8Array.hx",98,0xd9e22306)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(98)
