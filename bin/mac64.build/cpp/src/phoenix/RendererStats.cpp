...
{
HX_STACK_FRAME("phoenix.RendererStats","new",0x1cd0e80f,"phoenix.RendererStats.new","phoenix/Renderer.hx",432,0x3d4c7b7b)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(441)
...
{
		HX_STACK_FRAME("phoenix.RendererStats","reset",0xee7deb3e,"phoenix.RendererStats.reset","phoenix/Renderer.hx",443,0x3d4c7b7b)
		HX_STACK_THIS(this)
		HX_STACK_LINE(444)
		this->geometry_count = (int)0;
		HX_STACK_LINE(445)
...
::String RendererStats_obj::toString( ){
	HX_STACK_FRAME("phoenix.RendererStats","toString",0xe4927e9d,"phoenix.RendererStats.toString","phoenix/Renderer.hx",452,0x3d4c7b7b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(454)
