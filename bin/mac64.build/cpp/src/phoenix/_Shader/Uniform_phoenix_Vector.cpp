...
{
HX_STACK_FRAME("phoenix._Shader.Uniform_phoenix_Vector","new",0x82def399,"phoenix._Shader.Uniform_phoenix_Vector.new","phoenix/Shader.hx",734,0x14ec92d9)
HX_STACK_THIS(this)
...
{  hx::ObjectPtr< Uniform_phoenix_Vector_obj > _result_ = new Uniform_phoenix_Vector_obj();
...
Dynamic Uniform_phoenix_Vector_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic Uniform_phoenix_Vector_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
