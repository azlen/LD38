...
{
HX_STACK_FRAME("phoenix.geometry.TextureCoord","new",0x17ac6f89,"phoenix.geometry.TextureCoord.new","phoenix/geometry/TextureCoord.hx",62,0x1af0f827)
HX_STACK_THIS(this)
...
::phoenix::geometry::TextureCoord TextureCoord_obj::clone( ){
	HX_STACK_FRAME("phoenix.geometry.TextureCoord","clone",0x5e808ec6,"phoenix.geometry.TextureCoord.clone","phoenix/geometry/TextureCoord.hx",80,0x1af0f827)
	HX_STACK_THIS(this)
	HX_STACK_LINE(82)
...
::phoenix::geometry::TextureCoord TextureCoord_obj::set( Float _u,Float _v,Float _w,Float _t){
	HX_STACK_FRAME("phoenix.geometry.TextureCoord","set",0x17b03acb,"phoenix.geometry.TextureCoord.set","phoenix/geometry/TextureCoord.hx",86,0x1af0f827)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_u,"_u")
	HX_STACK_ARG(_v,"_v")
	HX_STACK_ARG(_w,"_w")
...
::phoenix::geometry::TextureCoord TextureCoord_obj::set_uv( Float _u,Float _v){
	HX_STACK_FRAME("phoenix.geometry.TextureCoord","set_uv",0xb326d295,"phoenix.geometry.TextureCoord.set_uv","phoenix/geometry/TextureCoord.hx",97,0x1af0f827)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_u,"_u")
	HX_STACK_ARG(_v,"_v")
	HX_STACK_LINE(99)
...
::String TextureCoord_obj::toString( ){
	HX_STACK_FRAME("phoenix.geometry.TextureCoord","toString",0xa5179ce3,"phoenix.geometry.TextureCoord.toString","phoenix/geometry/TextureCoord.hx",106,0x1af0f827)
	HX_STACK_THIS(this)
	HX_STACK_LINE(108)
