...
{
		HX_STACK_FRAME("phoenix.geometry.TextureCoordSet","destroy",0x001e9657,"phoenix.geometry.TextureCoordSet.destroy","phoenix/geometry/TextureCoord.hx",47,0x1af0f827)
		HX_STACK_THIS(this)
		HX_STACK_LINE(48)
		this->uv0 = null();
		HX_STACK_LINE(49)
