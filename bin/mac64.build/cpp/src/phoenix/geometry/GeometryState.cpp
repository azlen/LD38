...
Void GeometryState_obj::str( ){
{
		...
		if ((tmp15)){
			...
			HX_STACK_LINE(68)
			{
				...
				HX_STACK_LINE(68)
				::opengl::GLObject this1 = tmp17->texture;		HX_STACK_VAR(this1,"this1");
				HX_STACK_LINE(68)
				...
				HX_STACK_LINE(68)
				::String tmp20 = (HX_HCSTRING("GLTexture(","\x32","\x1e","\xd3","\x33") + tmp19);		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(68)
				tmp16 = (tmp20 + HX_HCSTRING(")","\x29","\x00","\x00","\x00"));
			}
			HX_STACK_LINE(68)
			::String tmp17 = (HX_HCSTRING("\t\t\t ","\xd7","\xc7","\xf9","\x05") + tmp16);		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(68)
			Dynamic tmp18 = hx::SourceInfo(HX_HCSTRING("GeometryState.hx","\x3f","\xca","\x64","\x05"),68,HX_HCSTRING("phoenix.geometry.GeometryState","\x22","\xa4","\x58","\xe5"),HX_HCSTRING("str","\xb1","\xa8","\x57","\x00"));		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(68)
