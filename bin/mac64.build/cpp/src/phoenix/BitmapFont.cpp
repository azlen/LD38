	...
	Void run(Dynamic resolve,Dynamic reject){
		...
		HX_STACK_ARG(reject,"reject")
		{
			...
			Void run(::snow::systems::assets::AssetText _asset){
				...
				{
					HX_STACK_LINE(292)
					::String tmp4 = _asset->text;		HX_STACK_VAR(tmp4,"tmp4");
					HX_STACK_LINE(292)
					...
					Void run(Array< ::Dynamic > _pages){
						HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","phoenix/BitmapFont.hx",313,0xdfcf0e40)
					...
					Void run(Dynamic _error){
						HX_STACK_FRAME("*","_Function_3_2",0x520271ba,"*._Function_3_2","phoenix/BitmapFont.hx",320,0xdfcf0e40)
			...
			int __ArgCount() const { return 1; }
			Void run(Dynamic _error){
				HX_STACK_FRAME("*","_Function_2_2",0x5201af79,"*._Function_2_2","phoenix/BitmapFont.hx",327,0xdfcf0e40)
				HX_STACK_ARG(_error,"_error")
				{
					HX_STACK_LINE(329)
					_g->set_state((int)4);
...
{
		HX_STACK_FRAME("phoenix.BitmapFont","apply_pages",0x16a15c82,"phoenix.BitmapFont.apply_pages","phoenix/BitmapFont.hx",340,0xdfcf0e40)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_pages,"_pages")
		HX_STACK_LINE(342)
...
Dynamic BitmapFont_obj::set_info( Dynamic _info){
	HX_STACK_FRAME("phoenix.BitmapFont","set_info",0x09cbdffc,"phoenix.BitmapFont.set_info","phoenix/BitmapFont.hx",352,0xdfcf0e40)
	HX_STACK_THIS(this)
...
::String BitmapFont_obj::toString( ){
	HX_STACK_FRAME("phoenix.BitmapFont","toString",0xce67633d,"phoenix.BitmapFont.toString","phoenix/BitmapFont.hx",364,0xdfcf0e40)
	HX_STACK_THIS(this)
	HX_STACK_LINE(365)
