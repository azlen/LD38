	...
	HX_STACK_LINE(570)
	{
		...
		if ((tmp2)){
			HX_STACK_LINE(570)
			{
				...
				HX_STACK_LINE(570)
				::phoenix::Vector _v = tmp3;		HX_STACK_VAR(_v,"_v");
				HX_STACK_LINE(570)
...
Void Spatial_obj::destroy( ){
{
		...
		HX_STACK_LINE(582)
		{
			...
			if ((tmp)){
				HX_STACK_LINE(582)
				{
					...
					HX_STACK_LINE(582)
					::phoenix::Vector _v = tmp1;		HX_STACK_VAR(_v,"_v");
					HX_STACK_LINE(582)
				...
				{
					HX_STACK_LINE(582)
					Dynamic tmp1 = this->pos_changed_dyn();		HX_STACK_VAR(tmp1,"tmp1");
					HX_STACK_LINE(582)
		...
		HX_STACK_LINE(584)
		{
			...
			if ((tmp)){
				...
				{
					HX_STACK_LINE(584)
					Dynamic tmp1 = this->scale_changed_dyn();		HX_STACK_VAR(tmp1,"tmp1");
					HX_STACK_LINE(584)
					bool tmp2 = (tmp1 != null());		HX_STACK_VAR(tmp2,"tmp2");
					HX_STACK_LINE(584)
					bool tmp3;		HX_STACK_VAR(tmp3,"tmp3");
					...
					if ((tmp3)){
						HX_STACK_LINE(584)
						::phoenix::Vector tmp4 = this->scale;		HX_STACK_VAR(tmp4,"tmp4");
						HX_STACK_LINE(584)
						this->scale_changed(tmp4);
					}
				}
			}
			HX_STACK_LINE(584)
			...
			HX_STACK_LINE(597)
			{
				...
				if ((tmp4)){
					HX_STACK_LINE(597)
					{
						...
						HX_STACK_LINE(597)
						::phoenix::Vector _v = tmp5;		HX_STACK_VAR(_v,"_v");
						HX_STACK_LINE(597)
