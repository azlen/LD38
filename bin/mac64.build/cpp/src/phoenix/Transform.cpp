		...
		HX_STACK_LINE(86)
		{
					...
					HX_STACK_LINE(86)
					{
						...
						while((true)){
							...
							HX_STACK_LINE(86)
							{
								...
								HX_STACK_LINE(86)
								::__hxcpp_memory_set_float(this1->buffer,(this1->byteOffset + (i * (int)4)),_this1->elements->__get(i));
							}
							HX_STACK_LINE(86)
							++(i);
						}
			...
			HX_STACK_LINE(86)
			{
				...
				if ((tmp3)){
					...
					{
						HX_STACK_LINE(86)
						bool tmp4 = (_this->scale_changed != null());		HX_STACK_VAR(tmp4,"tmp4");
						HX_STACK_LINE(86)
						bool tmp5;		HX_STACK_VAR(tmp5,"tmp5");
						HX_STACK_LINE(86)
						if ((tmp4)){
						...
						if ((tmp5)){
							HX_STACK_LINE(86)
							::phoenix::Vector tmp6 = _this->scale;		HX_STACK_VAR(tmp6,"tmp6");
							HX_STACK_LINE(86)
							_this->scale_changed(tmp6);
						}
					}
				}
				HX_STACK_LINE(86)
...
Void Transform_obj::clean( ){
{
		...
		if ((tmp3)){
			...
			{
				HX_STACK_LINE(235)
				::phoenix::Spatial tmp5 = this->get_world();		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(235)
				::phoenix::Spatial _this = tmp5;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(235)
				tmp4 = _this->matrix;
			}
			HX_STACK_LINE(235)
			...
			::phoenix::Spatial tmp5 = this->local;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(235)
			Array< Float > me = tmp5->matrix->elements;		HX_STACK_VAR(me,"me");
			HX_STACK_LINE(235)
			{
				HX_STACK_LINE(235)
				Array< Float > e = _this->elements;		HX_STACK_VAR(e,"e");
			...
			if ((tmp7)){
				...
				HX_STACK_LINE(241)
				{
					...
					if ((tmp9)){
						...
						{
							HX_STACK_LINE(241)
							bool tmp10 = (_this->pos_changed != null());		HX_STACK_VAR(tmp10,"tmp10");
							HX_STACK_LINE(241)
							...
							if ((tmp11)){
								HX_STACK_LINE(241)
								::phoenix::Vector tmp12 = _this->pos;		HX_STACK_VAR(tmp12,"tmp12");
								HX_STACK_LINE(241)
								_this->pos_changed(tmp12);
							}
						}
					}
					HX_STACK_LINE(241)
				...
				HX_STACK_LINE(241)
				{
					...
					if ((tmp9)){
						...
						{
							HX_STACK_LINE(241)
							bool tmp10 = (_this->scale_changed != null());		HX_STACK_VAR(tmp10,"tmp10");
							HX_STACK_LINE(241)
							bool tmp11;		HX_STACK_VAR(tmp11,"tmp11");
							HX_STACK_LINE(241)
							if ((tmp10)){
							...
							if ((tmp11)){
								HX_STACK_LINE(241)
								::phoenix::Vector tmp12 = _this->scale;		HX_STACK_VAR(tmp12,"tmp12");
								HX_STACK_LINE(241)
								_this->scale_changed(tmp12);
							}
						}
					}
					HX_STACK_LINE(241)
