...
class HXCPP_CLASS_ATTRIBUTES  Camera_obj : public ::luxe::Entity_obj{
	...
	public:
		...
		bool _connected;
		virtual Void _onwindowsized( ::snow::types::WindowEvent _event);
		Dynamic _onwindowsized_dyn();

		virtual ::phoenix::Vector set_size( ::phoenix::Vector _size);
		Dynamic set_size_dyn();

		virtual Void focus( ::phoenix::Vector _p,hx::Null< Float >  _t,Dynamic _oncomplete);
		Dynamic focus_dyn();
		...
		virtual Void shake( Float _amount);
		Dynamic shake_dyn();
