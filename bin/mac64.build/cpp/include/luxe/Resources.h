...
class HXCPP_CLASS_ATTRIBUTES  Resources_obj : public hx::Object{
	...
	public:
		...
		virtual bool remove( ::luxe::resource::Resource resource);
		Dynamic remove_dyn();
		...
		virtual ::snow::api::Promise load_audio( ::String _id,Dynamic _options);
		...
		virtual ::luxe::resource::AudioResource audio( ::String _id);
		Dynamic audio_dyn();
