...
class HXCPP_CLASS_ATTRIBUTES  Batcher_obj : public hx::Object{
	...
	public:
		...
		virtual bool submit_static_geometry( ::phoenix::geometry::Geometry geom);
		Dynamic submit_static_geometry_dyn();

		virtual bool submit_current_vertex_list( int type);
		...
		virtual int set_show_stats( int _value);
