...
class HXCPP_CLASS_ATTRIBUTES  Transform_obj : public ::luxe::ID_obj{
	...
	public:
		...
		bool _setup;
		bool _cleaning;
		cpp::ArrayBase _clean_handlers;
		cpp::ArrayBase _dirty_handlers;
		cpp::ArrayBase _pos_handlers;
		cpp::ArrayBase _rotation_handlers;
		cpp::ArrayBase _scale_handlers;
		cpp::ArrayBase _origin_handlers;
		cpp::ArrayBase _parent_handlers;
		bool _destroying;
