...
class HXCPP_CLASS_ATTRIBUTES  Matrix_obj : public hx::Object{
	...
	public:
		...
		virtual Float set_M11( Float _v);
		Dynamic set_M11_dyn();

		virtual Float set_M21( Float _v);
		Dynamic set_M21_dyn();

		virtual Float set_M31( Float _v);
		Dynamic set_M31_dyn();

		virtual Float set_M41( Float _v);
		Dynamic set_M41_dyn();

		virtual Float set_M12( Float _v);
		Dynamic set_M12_dyn();

		virtual Float set_M22( Float _v);
		Dynamic set_M22_dyn();

		virtual Float set_M32( Float _v);
		Dynamic set_M32_dyn();

		virtual Float set_M42( Float _v);
		Dynamic set_M42_dyn();

		virtual Float set_M13( Float _v);
		Dynamic set_M13_dyn();

		virtual Float set_M23( Float _v);
		Dynamic set_M23_dyn();

		virtual Float set_M33( Float _v);
		Dynamic set_M33_dyn();

		virtual Float set_M43( Float _v);
		Dynamic set_M43_dyn();

		virtual Float set_M14( Float _v);
		Dynamic set_M14_dyn();

		virtual Float set_M24( Float _v);
		Dynamic set_M24_dyn();

		virtual Float set_M34( Float _v);
		Dynamic set_M34_dyn();

		virtual Float set_M44( Float _v);
		Dynamic set_M44_dyn();

		virtual ::snow::api::buffers::ArrayBufferView float32array( );
