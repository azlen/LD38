...
class HXCPP_CLASS_ATTRIBUTES  Shader_obj : public ::luxe::resource::Resource_obj{
	...
	public:
		...
		virtual Void set_vector2_arr( ::String _name,::snow::api::buffers::ArrayBufferView _value);
		Dynamic set_vector2_arr_dyn();

		virtual Void set_vector3( ::String _name,::phoenix::Vector _value);
		Dynamic set_vector3_dyn();

		virtual Void set_vector3_arr( ::String _name,::snow::api::buffers::ArrayBufferView _value);
		Dynamic set_vector3_arr_dyn();

		virtual Void set_vector4( ::String _name,::phoenix::Vector _value);
		Dynamic set_vector4_dyn();

		virtual Void set_vector4_arr( ::String _name,::snow::api::buffers::ArrayBufferView _value);
		...
		virtual ::opengl::GLObject compile( int _type,::String _source);
		Dynamic compile_dyn();

		virtual bool link( );
		Dynamic link_dyn();

		virtual ::opengl::GLObject location( ::String _name);
