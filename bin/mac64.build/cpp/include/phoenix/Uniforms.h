...
class HXCPP_CLASS_ATTRIBUTES  Uniforms_obj : public hx::Object{
	...
	public:
		...
		virtual Void set_int( ::String _name,int _value,::opengl::GLObject _location);
		Dynamic set_int_dyn();

		virtual Void set_float( ::String _name,Float _value,::opengl::GLObject _location);
		Dynamic set_float_dyn();

		virtual Void set_vector2( ::String _name,::phoenix::Vector _value,::opengl::GLObject _location);
		Dynamic set_vector2_dyn();

		virtual Void set_vector2_arr( ::String _name,::snow::api::buffers::ArrayBufferView _value,::opengl::GLObject _location);
		Dynamic set_vector2_arr_dyn();

		virtual Void set_vector3( ::String _name,::phoenix::Vector _value,::opengl::GLObject _location);
		Dynamic set_vector3_dyn();

		virtual Void set_vector3_arr( ::String _name,::snow::api::buffers::ArrayBufferView _value,::opengl::GLObject _location);
		Dynamic set_vector3_arr_dyn();

		virtual Void set_vector4( ::String _name,::phoenix::Vector _value,::opengl::GLObject _location);
		Dynamic set_vector4_dyn();

		virtual Void set_vector4_arr( ::String _name,::snow::api::buffers::ArrayBufferView _value,::opengl::GLObject _location);
		Dynamic set_vector4_arr_dyn();

		virtual Void set_matrix4( ::String _name,::phoenix::Matrix _value,::opengl::GLObject _location);
		Dynamic set_matrix4_dyn();

		virtual Void set_matrix4_arr( ::String _name,::snow::api::buffers::ArrayBufferView _value,::opengl::GLObject _location);
		Dynamic set_matrix4_arr_dyn();

		virtual Void set_color( ::String _name,::phoenix::Color _value,::opengl::GLObject _location);
		Dynamic set_color_dyn();

		virtual Void set_texture( ::String _name,::phoenix::Texture _value,::opengl::GLObject _location);
